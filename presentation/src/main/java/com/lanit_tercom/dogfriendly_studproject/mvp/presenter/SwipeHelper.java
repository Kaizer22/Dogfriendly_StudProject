...
/**
 * Это надо чтобы кнопка удаления при слайде появлялась
 */
public abstract class SwipeHelper extends ItemTouchHelper.SimpleCallback {
    ...
    public SwipeHelper(Context context, RecyclerView recyclerView) {
        ...
        BUTTON_WIDTH = (int) (context.getResources().getDisplayMetrics().widthPixels * 0.2 - 10 * Math.round(context.getResources().getDisplayMetrics().density));
        attachSwipe();
    }
