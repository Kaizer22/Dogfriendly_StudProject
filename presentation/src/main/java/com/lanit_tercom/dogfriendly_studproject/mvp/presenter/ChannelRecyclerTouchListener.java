...
public class ChannelRecyclerTouchListener implements RecyclerView.OnItemTouchListener, OnActivityTouchListener {
    ...
    public ChannelRecyclerTouchListener(Fragment f, RecyclerView recyclerView) {
        this.fragment = f;
...
//        mSwipeListener = listener;
    ...
    public ChannelRecyclerTouchListener setClickable(OnRowClickListener listener) {
        this.clickable = true;
    ...
    public ChannelRecyclerTouchListener setSwipeable(int foregroundID, int backgroundID, OnSwipeOptionsClickListener listener) {
        ...
        if (fragment instanceof RecyclerTouchListenerHelper)
            ((RecyclerTouchListenerHelper) fragment).setOnActivityTouchListener(this);
    ...
    public ChannelRecyclerTouchListener setSwipeable(boolean value) {
    ...
    public ChannelRecyclerTouchListener setSwipeOptionViews(Integer... viewIds) {
        this.optionViews = new ArrayList<>(Arrays.asList(viewIds));
        return this;
    }

    public ChannelRecyclerTouchListener setUnSwipeableRows(Integer... rows) {
    ...
    public ChannelRecyclerTouchListener setViewsToFade(Integer... viewIds) {
        this.fadeViews = new ArrayList<>(Arrays.asList(viewIds));
        return this;
    }

    // the entire foreground is faded out as it is opened
    public ChannelRecyclerTouchListener setFgFade() {
    ...
    public void openSwipeOptions(int position) {
        if (!swipeable || rView.getChildAt(position) == null
            ...
            return;
        if (bgWidth < 2) {
            if (fragment.getActivity().findViewById(bgViewID) != null)
                bgWidth = fragment.getActivity().findViewById(bgViewID).getWidth();
